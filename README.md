...
cp -r job-application-claude-skills/skills/job-application-kit ~/.claude/skills/
```

Or per project:

```
mkdir -p .claude/skills && cp -r job-application-claude-skills/skills/job-application-kit .claude/skills/
```
...
I am switching from accounting to data analysis. Rewrite my resume for this role in the US.
